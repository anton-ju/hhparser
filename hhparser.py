...
#       returns true if player has opportunity of first action 
    ...
    def getTournamentID(self):
        ...
        if res: return res.groupdict().get('tid')
    ...
    def getHandID(self):
        ...
        res = re.search(id_regex, self.hand_history) 
        if res: return res.groupdict().get('hid')    
        else: return 0
    ...
    def getDateTimeET(self):
        ...
        if res: return res.groupdict().get('datetime') 
        else: return 0
    ...
    def getPActions(self):
        ...
        if res: 
            self.PActions = [ACTIONS[x[1]] for x in res]
            return self.PActions    
...
#       returns list with 1st item is total pot and all af the side pots if presents
    ...
    def getPActionsAmount(self):
        ...
        if self.p_amounts: return self.p_amounts
        else:
            if res:                 
                for x in res:
                    if self.p_amounts.get(x[0]): self.p_amounts[x[0]].append(int(x[1]))
                    else: self.p_amounts[x[0]] = [int(x[1])]
    ...
    def getFActionsAmount(self):
        ...
        if self.f_amounts: return self.f_amounts
        else:
            if res:                 
                for x in res:
                    if self.f_amounts.get(x[0]): self.f_amounts[x[0]].append(int(x[1]))
                    else: self.f_amounts[x[0]] = [int(x[1])]
    ...
    def getTActionsAmount(self):
        ...
        if self.t_amounts: return self.t_amounts
        else:
            if res:                 
                for x in res:
                    if self.t_amounts.get(x[0]): self.t_amounts[x[0]].append(int(x[1]))
                    else: self.t_amounts[x[0]] = [int(x[1])]
    ...
    def getRActionsAmount(self):
        ...
        if self.r_amounts: return self.r_amounts
        else:
            if res:                 
                for x in res:
                    if self.r_amounts.get(x[0]): self.r_amounts[x[0]].append(int(x[1]))
                    else: self.r_amounts[x[0]] = [int(x[1])]
...
#       returns hero name 
        ...
        if self.Hero: return self.Hero 
        else:
            if res: self.Hero = res.groupdict().get('hero') 
...
#               delete spaces 
    ...
    def getTurn(self):
        ...
        if self.turn: return  self.turn
        else:
            if res: self.turn = res.groupdict().get('turn') 
    ...
    def getRiver(self):
        ...
        if self.river: return  self.river
        else:
            if res: self.river = res.groupdict().get('river') 
...
#       winning in tournament 
        ...
        if self.winnings: return self.winnings
        else:
    ...
    def getChipWinnings(self):
        ...
        if self.chipwinnings: return self.chipwinnings
        else:
            res = re.findall(regex, self.summary_str)
            if res:
